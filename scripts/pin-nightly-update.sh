...
log "=== Pin nightly update starting ==="
...
sleep 2
curl -fsS "http://127.0.0.1:8000/health" >/dev/null && log "Health OK" || log "Health check failed (see journalctl)."

log "=== Pin nightly update finished ==="